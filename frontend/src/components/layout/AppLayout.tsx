    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row text-gray-900 font-sans">
      ...
      <AnimatePresence>
        {mobileSidebarOpen && (
          ...
          >
            ...
            <div className="py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">
              Navigation
            </div>
      ...
      <aside className="hidden md:flex md:w-64 flex-col bg-white border-r border-gray-200 shrink-0 sticky top-0 h-screen">
        ...
        <div className="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
            ...
            return (
              <Link
                ...
                className={`group flex items-center justify-between px-3 py-2.5 rounded-lg text-sm transition-all duration-200 ${
                  isActive 
                    ? 'bg-red-50 text-red-700 font-semibold border-l-3 border-red-600 shadow-xs' 
                    : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                }`}
              >
                <div className="flex items-center space-x-3">
                  <Icon className={`w-4 h-4 transition-transform duration-200 group-hover:scale-110 ${isActive ? 'text-red-600' : 'text-gray-500'}`} />
                  <span>{item.label}</span>
                </div>
                {item.badge ? (
          ...
          <div className="pt-6 px-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">
            External Resources
          </div>
          <a
            ...
            className="flex items-center justify-between px-3 py-2 text-xs text-gray-500 hover:text-blue-700 hover:bg-blue-50/60 rounded-lg transition-colors"
          >
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50/80">
          <div className="flex items-center justify-between">
            <Link to="/app/profile" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white">
        ...
        <header className="hidden md:flex h-16 border-b border-gray-200 px-6 items-center justify-between bg-white shrink-0">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to="/admin"
              className="text-xs font-semibold text-gray-700 hover:text-red-600 bg-gray-50 hover:bg-red-50 border border-gray-200 hover:border-red-200 px-2.5 py-1 rounded-md transition-colors"
            >
              Admin Console
            </Link>
            ...
            <button
              ...
              className="text-xs font-semibold text-gray-600 hover:text-red-600 cursor-pointer px-2 py-1 rounded hover:bg-gray-50 transition-colors"
