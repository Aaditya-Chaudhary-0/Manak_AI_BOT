        ...
        {activeSourceModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
            <div className="bg-white rounded-xl max-w-xl w-full p-6 shadow-xl border border-gray-200 relative space-y-4 max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg space-y-1 text-xs">
              ...
              <div className="p-3 bg-blue-50/50 border border-blue-200 rounded-lg space-y-1.5 text-xs text-blue-950">
                <span className="font-bold text-blue-900 block flex items-center space-x-1">
                  <FileText className="h-4 w-4 text-blue-600" />
                  <span>Full Citation Excerpt</span>
                </span>
                <p className="font-mono text-xs leading-relaxed bg-white/80 p-2.5 rounded border border-blue-100 text-gray-800">
              ...
              <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="px-3 py-1.5 text-xs font-semibold text-amber-700 bg-amber-50 hover:bg-amber-100 border border-amber-200 rounded-md"
                  >
                    Flag Needs Review
                  </button>
                  <button
