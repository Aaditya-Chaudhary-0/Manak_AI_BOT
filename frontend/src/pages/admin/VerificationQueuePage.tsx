  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
            <div className="bg-white rounded-xl max-w-xl w-full p-6 shadow-xl border border-gray-200 relative space-y-4 max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg text-xs space-y-1">
                ...
                <p className="text-gray-700 leading-relaxed font-mono bg-white p-2 rounded border border-gray-200">
              ...
              <div className="pt-4 border-t border-gray-100 flex items-center justify-between gap-2">
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-semibold text-red-600 bg-red-50 hover:bg-red-100 border border-red-200 rounded-md"
                >
                  Reject Item
                </button>
                <div className="flex space-x-2">
                  <button
                    ...
                    className="px-3 py-1.5 text-xs font-semibold text-amber-800 bg-amber-50 hover:bg-amber-100 border border-amber-200 rounded-md"
                  >
                    Request Review
                  </button>
                  <button
                    onClick={() => handleActionClick(activeItem, 'Approved')}
                    className="px-4 py-1.5 text-xs font-semibold text-white bg-green-600 hover:bg-green-700 rounded-md"
                  >
                    Approve Item
                  </button>
                </div>
        ...
        {confirmDialog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
            <div className="bg-white rounded-xl max-w-sm w-full p-5 shadow-xl border border-gray-200 space-y-4">
